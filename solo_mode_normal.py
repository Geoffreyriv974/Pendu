...
exit_picture = None
def random_word_normal():

    global windows_mod, exit_picture, zero, un, deux,trois, quatre, cinq, six, sept, huit, neuf, dix, sauver
    ...
    global display, random_word, nb_life

    nb_life = 10
    v_life = tk.StringVar(value="Vie restante : " + str(nb_life))

    with open("./liste_de_mots_normal.txt", "r", encoding="utf-8") as list:
    ...
    btn_generate = tk.Button(frame_generate, text="Générer le mots",relief="raised", borderwidth=10, font=("inconsolata", 15), bg="black", foreground="orange", command=generer_mot)
