...
def random_word_hard():
    ...
    with open("./liste_de_mots_difficile.txt", "r", encoding="utf-8") as list:
    ...
    btn_generate = tk.Button(frame_generate, text="Générer le mots",relief="raised", borderwidth=10, font=("inconsolata", 15), bg="black", foreground="red", command=generer_mot)
